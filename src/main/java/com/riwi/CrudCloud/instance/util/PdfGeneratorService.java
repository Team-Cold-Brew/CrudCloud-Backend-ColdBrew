...
public class PdfGeneratorService {
    ...
    /**
     * Generates a PDF with the instance credentials (including the RAW password).
     ...
     */
    public byte[] generateInstanceCredentialsPdf(Instance instance, String rawPassword) {
        ...
        try {
            ...
            Runnable addRow = () -> {
                ...
                table.addCell(createCell(instance.getName(), false));
                table.addCell(createCell("Database Type:", true));
                table.addCell(createCell(instance.getDbType().name(), false));
                table.addCell(createCell("Host/Direction:", true));
                table.addCell(createCell(instance.getHost(), false));
                table.addCell(createCell("Port:", true));
                table.addCell(createCell(String.valueOf(instance.getPort()), false));
                table.addCell(createCell("User:", true));
                table.addCell(createCell(instance.getUsername(), false));
                ...
                table.addCell(createCell(instance.getCreatedAt().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME), false));
            };
